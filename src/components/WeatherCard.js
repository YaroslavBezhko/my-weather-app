                ...
                <CardWrapper>
                    ...
                    <CurrentWeather>
                        ...
                        <CurrentWeatherInfo>
                            ...
                            <CurrentWeatherWind>{CurrentWeatherData.wind.speed} <span>км/ч</span></CurrentWeatherWind>
                        </CurrentWeatherInfo>
                    </CurrentWeather>
                </CardWrapper>
                <Link className="pageLink" to="/hourlyForecast">Показать почасовой прогноз</Link>
            </>
        );
    }
}
